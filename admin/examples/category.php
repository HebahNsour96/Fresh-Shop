                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                    <div class="form-group has-success">
                                        ...
                                        <input id="cat_name" name="cat_name" type="text" class="form-control cc-name valid">
                                    </div> 
                                    <div class="form-group has-success">
                                ...
                                <tbody>
                                       ...
                                       while ($category = mysqli_fetch_assoc($result)) 
                                       {
                                           ...
                                           echo "<tr>";
                                               ...
                                               echo "<td><img src='uploads/{$category['cat_img']}' width='350px' height='300px'></td>";
                                               
                                               echo "<td><button class='edit btn btn-info' data-id='{$category['cat_id']}' data-name='{$category['cat_name']}' data-image='{$category['cat_img']}'>Edit</button></td>";
                                               
                                               echo "<td><a href='delete_cat.php ?id={$category['cat_id']}' class='btn btn-danger' name='delete'>Delete</a></td>";
                                           echo "</tr>";
                                       }
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <form action="" method="post" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="cat_id" id='update_id' class="form-control" value="<?php echo $id; ?>">
                    <div class="modal-body">
                        <label for="cc-name" class="control-label mb-1">Category Name</label>
                        <input id="update_name" name="cat_name" type="text" class="form-control cc-name valid" value="<?php echo $name; ?>">
                        <label for="cc-name" class="control-label mb-1">Category Image</label>
